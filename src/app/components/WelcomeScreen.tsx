    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-100 via-purple-50 to-blue-50 px-6 relative overflow-hidden">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-5xl mb-4 bg-gradient-to-r from-pink-600 via-purple-600 to-blue-600 bg-clip-text text-transparent"
        >
          AI肌診断
        </motion.h1>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={onStart}
          className="w-full bg-gradient-to-r from-pink-500 via-purple-500 to-pink-500 bg-[length:200%_100%] text-white py-5 px-8 rounded-full shadow-2xl shadow-pink-300 relative overflow-hidden group"
        >
          <motion.div
            animate={{
              x: ["0%", "100%"]
          ...
          />
          <span className="relative text-lg">診断を始める</span>
        </motion.button>
      </motion.div>
    </div>
  );
